...
int main(void) {
    ...
    assert(vmm_map_page(&space,
                        0xFFFF800000201000ULL,
                        0x0000000000400001ULL,
                        0) == VMM_ERR_INVAL);
    ...
    assert(vmm_unmap_page(&space,
                          0xFFFF800000200000ULL) == VMM_MAP_OK);
    ...
    assert(vmm_unmap_page(&space,
                          0xFFFF800000200000ULL) == VMM_ERR_NOT_FOUND);
