...
x86_64_idt_set_gate(vector, (uint64_t)
(uintptr_t)x86_64_exception_stubs[vector], gate_type);
}
...
KERNEL_ASSERT(idtr.limit == (uint16_t)((X86_64_IDT_VECTOR_COUNT *
sizeof(x86_64_idt_entry_t)) - 1u));
